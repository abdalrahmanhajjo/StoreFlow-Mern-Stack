...
export function Cart() {
  ...
  const onSelectCustomer = (c: { id: string; name: string; points: number }) =>
            ...
            {discountOpen && (
              ...
              >
                ...
                >
                  ...
                  {(discountMode === 'percent' && discountRate > 0) ||
                    (discountMode === 'fixed' && discountFixed > 0) ? (
                    <button
                      type="button"
                      onClick={() =>
                        discountMode === 'percent'
                          ? setDiscountRate(0, role)
                          : setDiscountFixed(0, role)
                      }
                      style={{
                        border: 'none',
                        background: 'none',
